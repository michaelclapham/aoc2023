...
var
  ...
  line: AnsiString;
  i, num, power, powerTotal: longInt;
  possible: Boolean;
...
Begin
  ...
  begin
    ...
    power := Max(redMax,1) * Max(greenMax,1) * Max(blueMax,1);

    WriteLn('game num ', gameNum, ' power: ', power, ' power total before: ', powerTotal);
  ...
  WriteLn('Power total is: ', powerTotal);
